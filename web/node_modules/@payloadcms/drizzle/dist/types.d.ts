...
export interface CollectionOrVersionBlocksToJsonEntityToMigrate extends BaseBlocksToJsonEntityToMigrate {
    id: number | string;
    slug: string;
...
export type BlocksToJsonEntityToMigrate = CollectionOrVersionBlocksToJsonEntityToMigrate | GlobalBlocksToJsonEntityToMigrate;
export interface BlocksToJsonMigrator {
    collectAndSaveEntitiesToBatches(req: PayloadRequest, options?: {
        batchSize?: number;
    }): Promise<void>;
    ...
    migrateEntitiesFromTempFolder(req: PayloadRequest, options?: {
