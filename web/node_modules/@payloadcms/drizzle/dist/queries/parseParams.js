            ...
            if (relationOrPath) {
                ...
                if (Array.isArray(condition)) {
                    ...
                    if (typeof pathOperators === 'object') {
                        for (let operator of Object.keys(pathOperators)){
                            if (validOperatorSet.has(operator)) {
                                ...
                                if ((field.type === 'relationship' || field.type === 'upload') && Array.isArray(queryValue) && queryOperator === 'not_in') {
                    ...
                    NULL)`);
                                ...
                                if (operator === 'contains' && Array.isArray(queryValue) && 'hasMany' in field && field.hasMany && [
                                    'number',
                                    'select',
                                    'text'
                                ].includes(field.type)) {
                                    // Create OR conditions for each value in the array
                                    orConditions.push(...queryValue.map((val)=>adapter.operators[queryOperator](resolvedColumn, val)));
